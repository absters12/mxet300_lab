...
d2 = 0.5                      # distance in meters of segment 2 in the path
...
motions = [
    [0.4, 0, 2.5],            # Motion 1
    [0.0, pi/2, 0.8],            # Motion 2
    [0.4, 0.0, 1.25],            # Motion 3
    [0, pi/2, 0.8],            # Motion 4
    [0.4, 0.0, 2.5],            # Motion 5
    [0, -pi/2, 0.8],            # Motion 6
    [0.4, 0.0, 1.25],            # Motion 7
    [0.0, -pi/2, 0.8],            # Motion 8
    [0.4, 0.0, 2.5]            # Motion 9
]
...
for  count, motion in enumerate(motions):
    ...
    log.tmpFile(motion[0], "_x_dot.txt")
    log.tmpFile(motion[1], "_theta_dot.txt")
