...
def getVoltage():
    ...
    ##########################################
    return (readVolts()) # Be sure to return your variable name for your getVoltage()
...
def displayText():
    ...
    #################################################
    draw.text((40, 0), "Roberta", font=font, fill=255)
    ...
    draw.text((0, 10), "Voltage " + str(voltage) + "V", font=font, fill=255)

    draw.text((0, 30), "Im a sexy robot", font=font, fill=255)
